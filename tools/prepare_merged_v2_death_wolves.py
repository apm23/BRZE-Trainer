...
rep('Text = "BRZE Trainer 1.60 — Hook Test"; ClientSize = new Size(650, 520); StartPosition = FormStartPosition.CenterScreen;',
    'Text = "BRZE Trainer 1.60 — Death Modes + Reveal Map + Unlimited Wolves"; ClientSize = new Size(1000, 770); StartPosition = FormStartPosition.CenterScreen;')
...
rep('panel.Controls.Add(new Label { Text = "F10 Maximum Wolves — old trainer exact +0x250 remap", AutoSize = true });',
    'panel.Controls.Add(new Label { Text = "F10 = toggle Unlimited Wolves | PageDown = SINGLE instant death", AutoSize = true });')
...
print('MergedProgram.cs V7 generated OK')
